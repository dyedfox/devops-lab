...
def lambda_handler(event, context):
    ...
    for s3_record in event['Records']:
        ...
        # Launch MediaInfo, pass the signed URL of the uploaded asset to MediaInfo as an input, XML format
...
def save_record(bucket, key, xml_output):
    """
    ...
    try:
        ...
        preserved_metadata = {
            ...
            if k not in technical_metadata.keys() 
        }
